...
with st.spinner("Een momentje..."):
    if selected_sport != []:
        ...
        wordcloud= WordCloud(max_font_size=60, max_words=amount_words,width=1000,height=200, stopwords=STOPWORDS, background_color='#FFFFFF').generate_from_frequencies(
