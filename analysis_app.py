...
with st.spinner("Een momentje..."):
    if selected_sport != []:
        ...
        wordcloud= WordCloud(max_font_size=60, max_words=100,width=1000,height=200, stopwords=STOPWORDS, background_color='#100c44', colormap='gist_ncar').generate_from_frequencies(
